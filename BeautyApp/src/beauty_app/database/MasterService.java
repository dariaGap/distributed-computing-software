...
public class MasterService {
    ...
    public static Master convertEntityToMaster(Optional<MastersEntity> entity) {
        if (entity.isPresent()) {
            ...
            Master master = new Master(entity1.getId(),
                    entity1.getName(),
                    entity1.getLogin(),
                    entity1.getPassword(),
                    beauty_app.business_logic.Service.ServiceType.stringToServiceType(entity1.getServices()));
    ...
    public static MastersEntity convertMasterToEntity(Master master) {
        ...
        entity.setLogin(master.getLogin());
        entity.setName(master.getName());
        entity.setPassword(master.getPassword());
    ...
    public Master getMaster(String login){
        ...
        Optional<MastersEntity> entity = masterRepository.findByLogin(login);
        return convertEntityToMaster(entity);
    }
