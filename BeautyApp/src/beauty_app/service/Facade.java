...
public class Facade {
   ...
   /* public ObservableList<Entry> getEntriesByDate(LocalDate localDate){
    ...
    /*public ObservableList<Master> getMastersNames(Service beauty_app.service) {
        return FXCollections.observableArrayList(repo.getMasters(beauty_app.service.getType()));
    }*/
    ...
    /*public ObservableList<Service> getServicesNames(Service beauty_app.service) {
        List<Service> services = repo.getServices(beauty_app.service.getType());
        return FXCollections.observableArrayList(services);
    }*/



    /*public Boolean saveEntry(String clientName, String clientPhone,
    ...
    public Employee authorize(String login, String password){
        ...
        Admin admin = adminService.getAdmin(login);
