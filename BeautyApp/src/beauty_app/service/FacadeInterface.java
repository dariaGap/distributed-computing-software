...
public interface FacadeInterface {
   /* ObservableList<Master> getMastersNames();
    ObservableList<Master> getMastersNames(Service beauty_app.service);
    ...
    ObservableList<Service> getServicesNames(Service beauty_app.service);
...
*/
    ...
    Boolean saveEntry(String clientName, String clientPhone, Master master,
                      List<Service> services, Date date, Date time);
