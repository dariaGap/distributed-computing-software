...
public class Entry {
    ...
    public String toString() {
        String date = "Дата: " + entryDateAndTimeToString();
    ...
    public String entryDateAndTimeToString() {
        DateFormat timeFormat = new SimpleDateFormat("HH:mm");
        DateFormat dateFormat = new SimpleDateFormat("dd-MM-yyyy");

        return dateFormat.format(this.date.getTime()) + " " + timeFormat.format(this.time.getTime());
    }
